...
var riakMeta = map[string]MetricMeta{
	...
	"pbc_active": {
		...
		RateType: metadata.Gauge,
		Unit:     metadata.Process,
		Desc:     "Number of active Protocol Buffers connections.",
	},
	"node_get_fsm_active": {
		Metric:   "active",
		...
		RateType: metadata.Gauge,
		Unit:     metadata.Process,
		Desc:     "Number of active GET FSMs.",
	},
	"node_put_fsm_active": {
		Metric:   "active",
		...
		RateType: metadata.Gauge,
		Unit:     metadata.Process,
		Desc:     "Number of active PUT FSMs.",
	},
	"index_fsm_active": {
		Metric:   "active",
	...
	"node_get_fsm_rejected": {
		Metric:   "active",
		TagSet:   opentsdb.TagSet{"type": "get-reject"},
		RateType: metadata.Gauge,
		Unit:     metadata.Process,
		Desc:     "Number of GET FSMs actively being rejected by Sidejob's overload protection.",
	},
	"node_put_fsm_rejected": {
		Metric:   "active",
		TagSet:   opentsdb.TagSet{"type": "put-reject"},
		RateType: metadata.Gauge,
		Unit:     metadata.Process,
		Desc:     "Number of PUT FSMs actively being rejected by Sidejob's overload protection.",
	},
	"memory_total": {
		Metric:   "memory",
	...
	"sys_logical_processors": {
		Metric:   "erl.logical_processors",
		RateType: metadata.Gauge,
		Unit:     metadata.Process,
		Desc:     "Number of logical processors available on the system.",
	},
	"sys_process_count": {
		Metric:   "erl.nprocs",
		RateType: metadata.Gauge,
		Unit:     metadata.Process,
		Desc:     "Number of processes currently running in the Erlang VM.",
	},
	"sys_thread_pool_size": {
		Metric:   "erl.thread_pool_size",
		RateType: metadata.Gauge,
		Unit:     metadata.Thread,
		Desc:     "Number of threads in the asynchronous thread pool.",
	},
	...
	"vnode_set_update_total": {
		Metric:   "vnode.updates",
		TagSet:   opentsdb.TagSet{"type": "crdt-set"},
		RateType: metadata.Counter,
		Unit:     metadata.Operation,
		Desc:     "Total number of set update operations coordinated by local vnodes.",
	},
	"vnode_counter_update_total": {
		Metric:   "vnode.updates",
		TagSet:   opentsdb.TagSet{"type": "crdt-counter"},
		RateType: metadata.Counter,
		Unit:     metadata.Operation,
		Desc:     "Total number of counter update operations coordinated by local vnodes.",
	},
	"vnode_map_update_total": {
		Metric:   "vnode.updates",
		TagSet:   opentsdb.TagSet{"type": "crdt-map"},
		RateType: metadata.Counter,
		Unit:     metadata.Operation,
		Desc:     "Total number of map update operations coordinated by local vnodes.",
	},
	"node_gets_total": {
	...
	"search_query_throughput_count": {
		Metric:   "node.requests",
		TagSet:   opentsdb.TagSet{"type": "yz-query"},
		RateType: metadata.Counter,
		Unit:     metadata.Operation,
		Desc:     "Total number of Yokozuna search queries executed on this node.",
	},
	"search_index_throughput_count": {
		Metric:   "node.requests",
		TagSet:   opentsdb.TagSet{"type": "yz-index"},
		RateType: metadata.Counter,
		Unit:     metadata.Operation,
		Desc:     "Total number of Yokozuna document index operations executed on this node.",
	},
	"search_query_fail_count": {
		Metric:   "node.failedrequests",
		TagSet:   opentsdb.TagSet{"type": "yz-query"},
		RateType: metadata.Counter,
		Unit:     metadata.Operation,
		Desc:     "Total number of Yokozuna search queries that failed on this node.",
	},
	"search_index_fail_count": {
		...
		RateType: metadata.Counter,
		Unit:     metadata.Operation,
		Desc:     "Total number of Yokozuna document index operations that failed on this node.",
	},
	"search_query_latency_min": {
		Metric:   "node.latency.min",
		TagSet:   opentsdb.TagSet{"type": "yz-query"},
		RateType: metadata.Gauge,
		Unit:     metadata.Second,
		Desc:     "Min time between reception of client Search request and subsequent response to client.",
	},
	"search_index_latency_min": {
		...
		RateType: metadata.Gauge,
		Unit:     metadata.Second,
		Desc:     "Min time between reception of document Index request and subsequent response to client.",
	},
	"search_query_latency_max": {
		Metric:   "node.latency.max",
		TagSet:   opentsdb.TagSet{"type": "yz-query"},
		RateType: metadata.Gauge,
		Unit:     metadata.Second,
		Desc:     "Max time between reception of client Search request and subsequent response to client.",
	},
	"search_index_latency_max": {
		...
		RateType: metadata.Gauge,
		Unit:     metadata.Second,
		Desc:     "Max time between reception of document Index request and subsequent response to client.",
	},
	"search_query_latency_median": {
		...
		RateType: metadata.Gauge,
		Unit:     metadata.Second,
		Desc:     "Median time between reception of client Search request and subsequent response to client.",
	},
	"search_index_latency_median": {
		...
		RateType: metadata.Gauge,
		Unit:     metadata.Second,
		Desc:     "Median time between reception of document Index request and subsequent response to client.",
	},
	"search_query_latency_95": {
		...
		RateType: metadata.Gauge,
		Unit:     metadata.Second,
		Desc:     "95th percentile time between reception of client Search request and subsequent response to client.",
	},
	"search_index_latency_95": {
		...
		RateType: metadata.Gauge,
		Unit:     metadata.Second,
		Desc:     "95th percentile time between reception of document Index request and subsequent response to client.",
	},
	"search_query_latency_99": {
		...
		RateType: metadata.Gauge,
		Unit:     metadata.Second,
		Desc:     "99th percentile time between reception of client Search request and subsequent response to client.",
	},
	"search_index_latency_99": {
		...
		RateType: metadata.Gauge,
		Unit:     metadata.Second,
		Desc:     "99th percentile time between reception of document Index request and subsequent response to client.",
	},
	"search_query_latency_999": {
		Metric:   "node.latency.99.9th",
		TagSet:   opentsdb.TagSet{"type": "yz-query"},
		RateType: metadata.Gauge,
		Unit:     metadata.Second,
		Desc:     "99.9th percentile time between reception of client Search request and subsequent response to client.",
	},
	"search_index_latency_999": {
		...
		RateType: metadata.Gauge,
		Unit:     metadata.Second,
		Desc:     "99.9th percentile time between reception of document Index request and subsequent response to client.",
	},
	"object_counter_merge_time_mean": {
		...
		RateType: metadata.Gauge,
		Unit:     metadata.Second,
		Desc:     "Mean time of merge operation on crdt counter.",
	},
	"object_counter_merge_time_median": {
		...
		RateType: metadata.Gauge,
		Unit:     metadata.Second,
		Desc:     "Median time of merge operation on crdt counter.",
	},
	"object_counter_merge_time_95": {
		...
		RateType: metadata.Gauge,
		Unit:     metadata.Second,
		Desc:     "95th percentile time of merge operation on crdt counter.",
	},
	"object_counter_merge_time_99": {
		...
		RateType: metadata.Gauge,
		Unit:     metadata.Second,
		Desc:     "99th percentile time of merge operation on crdt counter.",
	},
	"object_counter_merge_time_100": {
		...
		RateType: metadata.Gauge,
		Unit:     metadata.Second,
		Desc:     "100th percentile time of merge operation on crdt counter.",
	},
	"object_set_merge_time_mean": {
		...
		RateType: metadata.Gauge,
		Unit:     metadata.Second,
		Desc:     "Mean time of merge operation on crdt set.",
	},
	"object_set_merge_time_median": {
		...
		RateType: metadata.Gauge,
		Unit:     metadata.Second,
		Desc:     "Median time of merge operation on crdt set.",
	},
	"object_set_merge_time_95": {
		...
		RateType: metadata.Gauge,
		Unit:     metadata.Second,
		Desc:     "95th percentile time of merge operation on crdt set.",
	},
	"object_set_merge_time_99": {
		...
		RateType: metadata.Gauge,
		Unit:     metadata.Second,
		Desc:     "99th percentile time of merge operation on crdt set.",
	},
	"object_set_merge_time_100": {
		...
		RateType: metadata.Gauge,
		Unit:     metadata.Second,
		Desc:     "100th percentile time of merge operation on crdt set.",
	},
	"object_map_merge_time_mean": {
		...
		RateType: metadata.Gauge,
		Unit:     metadata.Second,
		Desc:     "Mean time of merge operation on crdt map.",
	},
	"object_map_merge_time_median": {
		...
		RateType: metadata.Gauge,
		Unit:     metadata.Second,
		Desc:     "Median time of merge operation on crdt map.",
	},
	"object_map_merge_time_95": {
		...
		RateType: metadata.Gauge,
		Unit:     metadata.Second,
		Desc:     "95th percentile time of merge operation on crdt map.",
	},
	"object_map_merge_time_99": {
		...
		RateType: metadata.Gauge,
		Unit:     metadata.Second,
		Desc:     "99th percentile time of merge operation on crdt map.",
	},
	"object_map_merge_time_100": {
		...
		RateType: metadata.Gauge,
		Unit:     metadata.Second,
		Desc:     "100th percentile time of merge operation on crdt map.",
	},
